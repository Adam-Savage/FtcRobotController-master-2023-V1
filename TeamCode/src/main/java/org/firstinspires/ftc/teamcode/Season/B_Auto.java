...
@Config
@Autonomous
public class B_Auto extends LinearOpMode {
...
//---------------------------------------------------------------------------
        ...
        //RED - Purple mid and park right
//        encoderDrive(DRIVE_SPEED, 12.5, 12.5, 5.0);
//        encoderDrive(DRIVE_SPEED, -10, -10, 4.0);
//        encoderDrive(TURN_SPEED, 8.2, -8.2, 4.0);
//        encoderDrive(DRIVE_SPEED, 20, 20, 5.0);

        //RED - Purple mid and yellow right and park right
//        encoderDrive(DRIVE_SPEED, 12.5, 12.5, 5.0);
//        encoderDrive(DRIVE_SPEED, -1.8, -1.8, 5.0);
//        encoderDrive(TURN_SPEED, 8.2, -8.2, 5.0);
//        encoderDrive(DRIVE_SPEED, 18.2, 18.2, 5.0);
//
...
//        encoderDrive(DRIVE_SPEED, 5, 5, 5.0);
        ...
        //RED - Purple mid and yellow left and park left
        encoderDrive(DRIVE_SPEED, 12.5, 12.5, 5.0);
        encoderDrive(DRIVE_SPEED, -1.8, -1.8, 5.0);
        encoderDrive(TURN_SPEED, 8.2, -8.2, 5.0);
        encoderDrive(DRIVE_SPEED, 18.2, 18.2, 5.0);
